(function(d) {
 ...
 function i() {
  d(".work-lightbox-link").magnificPopup({
   gallery: {
    enabled: true
   },
   mainClass: "mfp-fade"
  });
  d(".lightbox-gallery-1").magnificPopup({
   gallery: {
    enabled: true
   }
  });
  d(".lightbox-gallery-2").magnificPopup({
   gallery: {
    enabled: true
   }
  });
  d(".lightbox-gallery-3").magnificPopup({
   gallery: {
    enabled: true
   }
  });
  d(".lightbox").magnificPopup()
 }
 ...
 (function(a) {
  ...
  if (window.location.hash) {
   a(".filter").each(function() {
    if (a(this).attr("data-filter") == "." + window.location.hash.replace("#", "")) {
