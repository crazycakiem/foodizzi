(function($){
    ...
    function init_shortcodes(){
        ...
        $(".tpl-minimal-tabs li.it-mn > a").click(function(){
            $("li.it-mn").removeClass("active");
            $(this).addClass("active");
            // if (!($(this).parent("li").hasClass("active"))) {
            //     tpl_tab_height = $(".tpl-minimal-tabs-cont > .tab-pane").filter($(this).attr("href")).height();
            //     $(".tpl-minimal-tabs-cont").animate({
...
function initPageSliders(){
    (function($){
        ...
        // Menu carousel
        $(".menu-item-carousel").owlCarousel({
            autoPlay: false,
            //stopOnHover: true,
            items: 4,
            itemsDesktop: [1199, 3],
...
//List page
    ...
    $('.section-title').on('click', '.view-type', function(e){
      e.preventDefault();
      $('.view-type').removeClass('enable');
      $(this).addClass('enable');
      var viewType = $(this).attr('data-view-type');
      $('.show-grid').attr('data-view-type', viewType);
      switch(viewType){
        case 'grid':
          $('.show-grid').show();
          $('.show-map').css('height', '0');
